...
try:
    ...
    net = ml.Model("trained_letter_S_F_Z_int8.tflite", load_to_fb=uos.stat('trained_letter_S_F_Z_int8.tflite')[6] > (gc.mem_free() - (64*1024)))
except Exception as e:
    print(e)
    raise Exception('Failed to load "trained_letter_S_F_Z_int8.tflite", did you copy the .tflite and labels_letter_S_F_Z.txt file onto the mass-storage device? (' + str(e) + ')')
